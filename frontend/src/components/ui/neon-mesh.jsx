...
/**
 * NeonMesh component
 * Interactive 3D Verlet physics cloth reacting to spatial vector force, perspective rotators, and kinetic drag.
 * 
 * @param {Object} props
 * @param {string} [props.title="KINETIC"]
 * @param {string} [props.subtitle=""]
 * @param {string} [props.description="Interactive 3D Verlet physics cloth reacting to spatial vector force, perspective rotators, and kinetic drag."]
...
export function NeonMesh({
    ...
    return (
        <div
            ref={containerRef}
            className={`relative w-full h-screen overflow-hidden select-none bg-black ${className}`}
        >
            <canvas
                ref={canvasRef}
